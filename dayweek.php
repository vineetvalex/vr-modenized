...
<script>
		...
		<ul id="navigation">
		<li><a href="dayweek.php">Day of Week Overview</a></li>
		<li><a href="month.php">Month Overview</a></li>
		</ul>
...
echo $year;
   ...
   // $month = date('F', mktime(0,0,0,$m, 1, $year));
	//echo $array[$month]. ; 
	$dayweek = array("January", "February", "March", "April", "May", "June", "July", " August", "September", "October", "November", "December");
