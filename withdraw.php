...
<h2>SUBMIT Bank check withdrawal</h2> </p>    
          ...
          <div ></p>
			...
			<label>Withdraw Amount<span class="req">*</span></label>
              <input type="text" name="amount" placeholder="" required autocomplete="off" />
			<label>Date of Withdrawal<span class="req">*</span> </label> 
	...
	echo "<h2>Bank Withdrawal Details</h2> </p> ";
		include('db.php');
...
echo "<table>";
     echo "<thead>";
      ...
      echo "</thead>";
      echo "<tbody>";
       $result = mysql_query("select * from bankwithdraw"); 
	  ...
	  <?php
			session_start ();
			 ...
			 $query = "INSERT into `bankwithdraw` (amount, date, year) VALUES ( '$_POST[amount]', '$_POST[date]', '$_POST[year]')";
			  $result = mysql_query($query);
			  
						if(!$result){
						die("ERROR: " . mysql_error() );
						}
			  echo "<script type='text/javascript'>alert('Withdrawal Submitted Succesfully')</script>";			 
